...
RDB.setRules([
	...
	new Rule('response: $host.set-to("foo.example.com:9877")'),
	new Rule('response: if $host eq "foo.example.com:9877", @test("host")'),
	new Rule('response: $host.set-to("bar:80")'),
	new Rule('response: if $host eq "bar", @test("host80")'),
]);
...
var passes = {
	...
	notLt:false,notLte:false,notGt:false,notGte:false,aurl:false,host:false,host80:false,
};
