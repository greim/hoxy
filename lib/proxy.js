...
module.exports = Base.extend(function(opts){
  ...
  intercept: function(opts, intercept){
    ...
    var phase = opts.phase,
        interceptName = intercept.__name || '';
    ...
    if (!!interceptName) {
      intercept.__name = interceptName
    }
  ...
  remove: function(phase, interceptName){
    ...
    var fn = _.isFunction(interceptName) ? interceptName : function (it) { return it.__name === interceptName; };
